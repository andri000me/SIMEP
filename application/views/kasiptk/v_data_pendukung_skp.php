                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-sm btn-info" href="<?php echo site_url('kasiptk/data_pendukung_skp/editDataPendukungSKP/' . $ps->id_data_pendukung) ?>" title="Edit"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                <?php
                                    }                    
